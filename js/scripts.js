...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        a.forms.captcha.widgets = [], b(".input-checkbox").off("click.mr").on("click.mr", function(a) {
            var c = b(this);
            if (!b(a.target).is("input")) {
                c.toggleClass("checked");
                var d = c.find("input");
                return d.prop("checked") === !1 ? d.prop("checked", !0) : d.prop("checked", !1), d.trigger("change"), !1
            }
        }), b(".input-radio").off("click.mr").on("click.mr", function(a) {
            if (!b(a.target).is("input")) {
                var c = b(this),
    ...
    var e = function(a) {
        a("[data-gradient-bg]").each(function(b, c) {
            var d, e, f, g = a(this),
                ...
                j = [],
                k = [];
            if (g.prepend('<canvas id="' + h + '"></canvas>'), e = /^(#[0-9|a-f|A-F]{6}){1}([ ]*,[ ]*#[0-9|a-f|A-F]{6})*$/.test(i), e === !0) for (i = i.replace(" ", ""), i = i.split(","), d = i.length, d % 2 !== 0 && i.push(i[d - 1]), f = 0; d / 2 > f; f++) k = [], k.push(i.shift()), k.push(i.shift()), j.push(k);
            a(this), new Granim({
                element: "#" + h,
                name: "basic-gradient",
