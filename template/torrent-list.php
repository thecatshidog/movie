...
<div class="main-container">
    ...
    <section class="imagebg  hidden-sm hidden-xs cover bg--dark height-40 text-center" style="padding-bottom: 0">
        ...
        <div class="background-image-holder" style="background: url(http://image.bt0.com/background/background14.jpg); opacity: 1;height: 700px;">
            <img alt="background" src="http://image.bt0.com/background/background14.jpg">
        </div>
