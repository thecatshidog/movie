...
<div class="main-container">
    <section class="imagebg  bg--dark" style="padding-bottom: 0">
        ...
        <div class="background-image-holder  hidden-xs hidden-sm" style="background: url(http://image.bt0.com/background/background21.jpg); opacity: 1;height:700px">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="text-center hidden-xs hidden-sm" style="margin: 8em  0">
                    <h1>不太灵 - 优雅的影视站</h1>
                </div>
                <!--end slider-->
            </div>
                ...
                <div class="col-sm-12 text-center">
                    <div class="masonry masonry-demos">
                        ...
                        <div class="masonry__container">
                            ...
                            [ecmsinfo]'1,3',28,100,0,0,14,0,'isgood=1','onclick desc'[/ecmsinfo]
