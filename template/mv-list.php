...
<div class="main-container">
    ...
    <section class="imagebg bg--dark" style="padding-bottom: 3em">
        ...
        <div class="background-image-holder" style="background: url(http://image.bt0.com/background/background26.jpg); opacity: 1;height: 700px;">
            <img alt="background" src="http://image.bt0.com/background/background26.jpg">
        </div>
        <!--end of container-->
