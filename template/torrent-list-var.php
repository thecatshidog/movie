...
$mv=$empire->fetch1("select id,titlepic from www_92game_net_ecms_movie where (douban_id='$r[douban_id]' or imdb='$r[imdb]') limit 1");
    ...
    <div class="cta cta--horizontal text-center-xs ">
        <div class="col-sm-2">
            ...
            <a href="/subject/'.$mv[id].'.html" >
                <img class="cover-pic" alt="[!--mvtitle--]" title="[!--mvtitle--] 最新资源" src="'.$mv[titlepic].'" />
            </a>
        </div>
        <div class="col-sm-10">
