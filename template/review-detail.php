...
<head>
    <meta charset="utf-8">
    <title>[!--pagetitle--] [!--mvtitle--]影评- 不太灵</title>
    <meta name="description" content="[!--smalltext--]">
    <meta name="keywords" content="[!--title--],[!--mvtitle--]影评">
    [!--temp.css--]
</head>
<body class=" ">
<a id="start"></a>
                            ...
                            <div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-1">
                                <article>
                                    <div class="article__title text-center">
                                        ...
                                        <span>[!--newstime--]  </span>
                                        <span><a href="[!--writer_link--]" target="_blank" style="text-decoration: none" title="访问作者 [!--writer--] 的豆瓣主页">[!--writer--]</a></span>
                                    </div>
                                    <!--end article title-->
